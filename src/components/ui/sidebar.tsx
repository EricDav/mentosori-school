...
>(({ className, onClick, ...props }, ref) => {
  ...
  return (
    <Button
      ...
      variant="ghost"
      size="icon"
      className={cn("h-8 w-8 group-data-[collapsible=icon]:group-data-[state=expanded]:flex group-data-[collapsible=icon]:hidden", className)}
      onClick={(event) => {
        onClick?.(event)
        toggleSidebar()
      }}
    ...
    const button = (
      <Comp
        ...
        className={cn(
          ...
          state === 'collapsed' && 'justify-center p-2 w-9',
          className
        )}
        {...props}
      >
